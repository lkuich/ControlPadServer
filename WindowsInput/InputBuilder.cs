...
namespace WindowsInput
{
    ...
    internal class InputBuilder : IEnumerable<INPUT>
    {
        ...
        /// <param name="useScanCode">Tells the simulator to use ScanCodes instead of keycodes.</param>
        /// </summary>
        public InputBuilder(bool useScanCode = false)
        {
            _inputList = new List<INPUT>();
            UseScanCodes = useScanCode;
        }
                        ...
                        Data =
                            {
                                Keyboard =
                                    new KEYBDINPUT
                                        {
                                            KeyCode = UseScanCodes ? (UInt16)0 : key,
                                            Scan = UseScanCodes ? (UInt16)NativeMethods.MapVirtualKey(key, 0) : (UInt16)0,
