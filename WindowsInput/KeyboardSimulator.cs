...
namespace WindowsInput
{
    ...
    public class KeyboardSimulator : IKeyboardSimulator
    {
        ...
        private bool UseScanCodes { get; set; }
        ...
        {
            var inputList = new InputBuilder(UseScanCodes).AddKeyDown(keyCode).ToArray();
        ...
        {
            var inputList = new InputBuilder(UseScanCodes).AddKeyUp(keyCode).ToArray();
            SendSimulatedInput(inputList);
            return this;
        }
        ...
        {
            var inputList = new InputBuilder(UseScanCodes).AddKeyPress(keyCode).ToArray();
            SendSimulatedInput(inputList);
            return this;
        }
        ...
        public IKeyboardSimulator TextEntry(string text)
        {
            ...
            var inputList = new InputBuilder(UseScanCodes).AddCharacters(text).ToArray();
            SendSimulatedInput(inputList);
            return this;
        }
        ...
        {
            var inputList = new InputBuilder(UseScanCodes).AddCharacter(character).ToArray();
            SendSimulatedInput(inputList);
            return this;
        }
